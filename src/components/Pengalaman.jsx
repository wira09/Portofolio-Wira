  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-black dark:text-white flex items-center justify-center">
          <GiSkills className="mr-2" /> Pengalaman
        </h2>
      </div>
            ...
            <div className="ml-2">
              ...
              <div className="mt-2">
                <p className="text-black dark:text-white text-sm flex items-start">
                  <GiSkills className="mr-2 mt-1 flex-shrink-0" />
